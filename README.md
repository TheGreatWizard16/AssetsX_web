...
The exam brief prohibits any JS/PHP framework or library beyond what it names (HTML5/PHP, CSS3, Bootstrap 5, JavaScript, Chart.js, a stock API). Firebase normally means importing the Firebase SDK — that's a real client library, and it's exactly what was removed from this repo in an earlier commit for that reason.
